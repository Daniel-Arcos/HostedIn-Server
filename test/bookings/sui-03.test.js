...
describe('Booking  Endpoints: Get Guest Bookings', () => {
    ...
    it('GET: get current Bokings of guest', async () => {
        const res = await request(app)
    ...
    it('GET: get od bookings of guest', async () => {
        const res = await request(app)
    ...
    it('GET: get geust bookings with host', async () => {
        const res = await request(app)
            .get(`/api/v1/users/${userGuestTest._id}/bookings?status=Overdue`).send(                
            ).set('Authorization', `Bearer ${tokenHost}`)
        console.log(res.body.message)
    ...
    //GET reservaciones con mal query
    it('GET: get bookings with wrong query', async () => {
        const res = await request(app)
            .get(`/api/v1/users/${userGuestTest._id}/bookings?statu=Overdue`).send(                
            ).set('Authorization', `Bearer ${tokenGuest}`)
        console.log(res.body.message)
    ...
    //GET reservaciones de guest con un host
    it('GET: get bookings with guest without bookings  ', async () => {
        const res = await request(app)
            .get(`/api/v1/users/${userGuestTest2._id}/bookings?status=Current`).send(                
